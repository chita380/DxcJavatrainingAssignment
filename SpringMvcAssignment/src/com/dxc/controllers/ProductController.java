...
public class ProductController {
	...
	public ModelAndView delProducts(@RequestParam(value="id") int id) {//get the form id as parameter
		...
		for(Product product:productRepo.getProducts()) {
			if(id==product.getId()) {
				...
				return new ModelAndView("delproduct","message","Product Id:"+id+" deleted");
			}
		}
		// write logic to delete product from repo
		
		return new ModelAndView("delproduct","message","Product Id:"+id+"Does not exist !");
	}	
